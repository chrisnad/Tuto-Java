...
//		List<Mot> liste = this.mots.get(entree);
//		Set<Mot> mots = new HashSet<Mot>();
//		for(Mot mot : liste){
//			mots.add(mot);
//		}
//System.out.println("000000000000000000000000000000");
//System.out.println(motsParEntree.get(entree) == null);
		Set<Mot> mots = new HashSet<Mot>();
		mots.addAll(motsParEntree.get(entree));
		return mots;
	}

	public Set<Entree> trouverEntreesAssocieesAuMot(String forme)  throws MotInexistantException {
	...
	public Set<Entree> trouverEntreesAssocieesAuMotParCategorie(String forme, Categorie categorie)  throws MotInexistantException {
		List<Mot> liste = this.mots.get(forme);
		Set<Entree> entrees = new HashSet<Entree>();
		if(liste == null) {
			throw new MotInexistantException();
